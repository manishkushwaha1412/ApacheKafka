...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory(){
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "manish-1");
    ...
    public ConsumerFactory<String, Student> userConsumerFactory(){
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "manish-2");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Student> userKafkaListenerFactory(){
        ConcurrentKafkaListenerContainerFactory<String, Student> config = new ConcurrentKafkaListenerContainerFactory<>();
        config.setConsumerFactory(userConsumerFactory());
        return config;
    }
}
